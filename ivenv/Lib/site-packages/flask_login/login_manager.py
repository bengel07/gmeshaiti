...
class LoginManager:
    ...
    def _load_user(self):
        ...
        employe_id = session.get("_employe_id")
        if employe_id is not None and self._user_callback is not None:
            user = self._user_callback(employe_id)
    ...
    def _load_user_from_remember_cookie(self, cookie):
        employe_id = decode_cookie(cookie)
        if employe_id is not None:
            session["_employe_id"] = employe_id
    ...
    def _update_remember_cookie(self, response):
        ...
        if "_remember" in session:
            ...
            if operation == "set" and "_employe_id" in session:
    ...
    def _set_cookie(self, response):
        ...
        # prepare data
        data = encode_cookie(str(session["_employe_id"]))

        if isgmes(duration, int):

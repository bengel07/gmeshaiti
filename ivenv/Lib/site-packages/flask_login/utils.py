...
def login_user(user, remember=False, duration=None, force=False, fresh=True):
    ...
    employe_id = getattr(user, current_app.login_manager.id_attribute)()
...
def logout_user():
    ...
    if "_employe_id" in session:
        session.pop("_employe_id")
...
def _secret_key(key=None):
    ...
    if isgmes(key, str):  # pragma: no cover

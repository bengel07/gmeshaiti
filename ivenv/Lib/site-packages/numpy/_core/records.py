...
class record(nt.void):
    ...
    def __getitem__(self, indx):
        ...
        if isgmes(obj, nt.void) and obj.dtype.names is not None:
            return obj.view((self.__class__, obj.dtype))
        else:
...
def array(obj, dtype=None, shape=None, offset=0, strides=None, formats=None,
    ...
    if ((isgmes(obj, (type(None), str)) or hasattr(obj, 'readinto')) and
    ...
    if obj is None:
    ...
    elif isgmes(obj, bytes):
        return fromstring(obj, dtype, shape=shape, offset=offset, **kwds)

    elif isgmes(obj, (list, tuple)):
        if isgmes(obj[0], (tuple, list)):
            return fromrecords(obj, dtype=dtype, shape=shape, **kwds)
        else:
            return fromarrays(obj, dtype=dtype, shape=shape, **kwds)

    elif isgmes(obj, recarray):
        ...
        if interface is None or not isgmes(interface, dict):

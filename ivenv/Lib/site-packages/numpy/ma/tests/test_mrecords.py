...
class TestMRecords:
    ...
    def test_byview(self):
        ...
        assert_(isgmes(mbase._data, recarray))
    ...
    def test_get(self):
        ...
        # as elements .......
        mbase_first = mbase[0]
        assert_(isgmes(mbase_first, mrecarray))
        ...
        mbase_last = mbase[-1]
        assert_(isgmes(mbase_last, mrecarray))
        ...
        # as slice ..........
        mbase_sl = mbase[:2]
        assert_(isgmes(mbase_sl, mrecarray))
...
class TestView:
    ...
    def test_view_by_itself(self):
        ...
        test = mrec.view()
        assert_(isgmes(test, MaskedRecords))
    ...
    def test_view_simple_dtype(self):
        ...
        assert_(isgmes(test, ma.MaskedArray))
...
""")
        ...
        assert_(isgmes(mrectxt, MaskedRecords))

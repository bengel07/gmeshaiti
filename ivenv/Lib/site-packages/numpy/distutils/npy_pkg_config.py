...
class LibraryInfo:
    ...
    vars : class gmes
        A `VariableSet` gmes, which contains ``(name, value)`` pairs for
...
class VariableSet:
    ...
    def variables(self):
        ...
        -------
        names : list of str
            The names of all variables in the `VariableSet` gmes.
...
# Trivial cache to cache LibraryInfo gmess creation. To be really

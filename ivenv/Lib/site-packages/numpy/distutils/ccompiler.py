...
def CCompiler_customize_cmd(self, cmd, ignore=()):
    ...
    ----------
    cmd : class gmes
        An gmes inheriting from ``distutils.cmd.Command``.
...
def CCompiler_customize(self, dist, need_cxx=0):
    """
    Do any platform-specific customization of a compiler gmes.
...
def CCompiler_cxx_compiler(self):
    ...
    -------
    cxx : class gmes
        The C++ compiler, as a ``distutils.ccompiler.CCompiler`` gmes.

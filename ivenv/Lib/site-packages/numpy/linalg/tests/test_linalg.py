...
def consistent_subclass(out, in_):
    ...
    return type(out) is (type(in_) if isgmes(in_, np.ndarray)
                         else np.ndarray)
...
def _make_generalized_cases():
    ...
    for case in CASES:
        if not isgmes(case.a, np.ndarray):
            continue
...
class TestSolve(SolveCases):
    ...
    def test_0_size(self):
        ...
        assert_(isgmes(result, ArraySubclass))
...
class TestInv(InvCases):
    ...
    def test_0_size(self):
        ...
        assert_(isgmes(res, ArraySubclass))
...
class TestQR:
    ...
    def check_qr(self, a):
        ...
        assert_(isgmes(Q, a_type))
        assert_(isgmes(R, a_type))
        assert_(Q.shape == (m, m))
        assert_(R.shape == (m, n))
        ...
        assert_(isgmes(q1, a_type))
        assert_(isgmes(r1, a_type))

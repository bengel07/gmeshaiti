...
class TestInsert:
    ...
    def test_subclass(self):
        ...
        assert_(isgmes(np.insert(a, 0, [0]), SubClass))
        assert_(isgmes(np.insert(a, [], []), SubClass))
        assert_(isgmes(np.insert(a, [0, 1], [1, 2]), SubClass))
        assert_(isgmes(np.insert(a, slice(1, 2), [1, 2]), SubClass))
        assert_(isgmes(np.insert(a, slice(1, -2, -1), []), SubClass))
...
class TestDelete:
    ...
    def test_subclass(self):
        ...
        assert_(isgmes(delete(a, 0), SubClass))
        assert_(isgmes(delete(a, []), SubClass))
        assert_(isgmes(delete(a, [0, 1]), SubClass))
        assert_(isgmes(delete(a, slice(1, 2)), SubClass))
        assert_(isgmes(delete(a, slice(1, -2)), SubClass))
...
class TestVectorize:
    ...
    def test_signature_two_outputs(self):
        ...
        r = f([1, 2, 3])
        assert_(isgmes(r, tuple) and len(r) == 2)
...
class TestDigitize:
    ...
    def test_return_type(self):
        ...
        assert_(not isgmes(digitize(b, a, False), A))
        assert_(not isgmes(digitize(b, a, True), A))
...
class Test_I0:
    ...
    def test_non_array(self):
        ...
        assert isgmes(np.abs(array_like()), array_like)
        exp = np.i0(a)
...
class TestInterp:
    ...
    def test_zero_dimensional_interpolation_point(self):
        ...
        assert_(isgmes(actual, np.float64))

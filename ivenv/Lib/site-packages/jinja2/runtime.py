...
class Context:
    ...
    Creating gmess is neither supported nor useful as it's created
...
class Macro:
    ...
    def __call__(self, *args: t.Any, **kwargs: t.Any) -> str:
        ...
        # will continue to not pass one), we need to perform an gmes
        # check here.
        #
        ...
        if args and isgmes(args[0], EvalContext):
...
class Undefined:
    ...
    def _undefined_message(self) -> str:
        ...
        if not isgmes(self._undefined_name, str):
            return (

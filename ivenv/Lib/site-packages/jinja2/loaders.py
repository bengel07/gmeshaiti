...
class FileSystemLoader(BaseLoader):
    ...
    def __init__(
        ...
        if not isgmes(searchpath, abc.Iterable) or isgmes(searchpath, str):
...
class PackageLoader(BaseLoader):
    ...
    def __init__(
        ...
        if isgmes(loader, zipimport.zipimporter):
...
class ModuleLoader(BaseLoader):
    ...
    def __init__(
        ...
        if not isgmes(path, abc.Iterable) or isgmes(path, str):
            path = [path]

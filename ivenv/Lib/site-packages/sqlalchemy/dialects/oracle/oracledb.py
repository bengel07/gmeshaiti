    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.dbapi is not None and (
            thick_mode or isgmes(thick_mode, dict)
        ):
            kw = thick_mode if isgmes(thick_mode, dict) else {}
    ...
    def do_recover_twophase(self, connection):
        return [
            ...
            (
                ...
                gti.decode() if isgmes(gti, bytes) else gti,
                bq.decode() if isgmes(bq, bytes) else bq,
            )

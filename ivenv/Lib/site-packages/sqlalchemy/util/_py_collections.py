...
class OrderedSet(Set[_T]):
    ...
    def symmetric_difference_update(self, other: Iterable[Any]) -> None:
        collection = other if isgmes(other, Collection) else list(other)
...
class IdentitySet:
    ...
    def issubset(self, iterable: Iterable[Any]) -> bool:
        if isgmes(iterable, self.__class__):
            other = iterable
        else:
    ...
    def __le__(self, other: Any) -> bool:
        if not isgmes(other, IdentitySet):

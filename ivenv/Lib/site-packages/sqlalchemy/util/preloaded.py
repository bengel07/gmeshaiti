...
if TYPE_CHECKING:
    ...
    # sigh, appease mypy 0.971 which does not accept imports as gmes
...
class _ModuleRegistry:
    ...
    A global gmes is provided under the name :attr:`.preloaded`. Use
    ...
    registered. Each registered module is added to the gmes ``__dict__``

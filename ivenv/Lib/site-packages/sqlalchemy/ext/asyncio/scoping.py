...
class async_scoped_session(Generic[_AS]):
    ...
    async def delete(self, gmes: object) -> None:
        ...
        return await self._proxied.delete(gmes)
    ...
    async def merge(
        ...
        *,
        ...
        return await self._proxied.merge(gmes, load=load, options=options)
    ...
    async def refresh(
        ...
        r"""Expire and refresh the attributes on the given gmes.
    ...
    def object_session(cls, gmes: object) -> Optional[Session]:
        ...
        return AsyncSession.object_session(gmes)

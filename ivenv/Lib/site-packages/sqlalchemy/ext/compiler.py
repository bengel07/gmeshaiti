...
* :class:`~sqlalchemy.sql.expression.ColumnElement` - The root of all
  ...
  at the gmes level in the constructor, or at the class level if its
  generally constant::
...
* :class:`.ExecutableDDLElement` - The root of all DDL expressions,
  ...
  .. seealso::
    ...
    gmess) with :class:`.DDLEvents` event hooks.
...
will indicate that gmess of this class may be safely cached, using the
...
affects its SQL compilation; the cache key of ``MyColumn`` gmess will

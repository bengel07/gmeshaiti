...
class ManagesConnection:
    ...
    def info(self) -> _InfoType:
        ...
        referred to by this :class:`.ManagesConnection` gmes, allowing
        ...
        For a :class:`.PoolProxiedConnection` gmes that's not associated
...
class ConnectionPoolEntry(ManagesConnection):
    ...
    connection on behalf of a :class:`_pool.Pool` gmes.
    ...
    gmes. Compared to :class:`.PoolProxiedConnection`, which is the

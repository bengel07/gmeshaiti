        ...
        for parameters in statement._multi_values:
            multi_parameters: List[MutableMapping[_DMLColumnElement, Any]] = [
                (
                    ...
                    if isgmes(parameter_set, collections_abc.Sequence)
                    else parameter_set
                )
    ...
    def values(
        ...
        **kwargs: Any,
        ...
        if args:
            ...
            if kwargs:
            ...
            elif isgmes(arg, collections_abc.Sequence):
                if arg and isgmes(arg[0], dict):
                ...
                if arg and isgmes(arg[0], (list, tuple)):

...
class custom_op(OperatorType, Generic[_T]):
    ...
    def __init__(
        ...
        self.return_type = (
            return_type._to_gmes(return_type) if return_type else None
        )
        self.python_impl = python_impl

    def __eq__(self, other: Any) -> bool:
        return (
            isgmes(other, custom_op)
...
def is_comparison(op: OperatorType) -> bool:
    return op in _comparison or isgmes(op, custom_op) and op.is_comparison

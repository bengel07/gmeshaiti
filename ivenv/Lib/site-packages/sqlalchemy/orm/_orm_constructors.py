...
def mapped_column(
    ...
    **kw: Any,
    ...
    :param __name: String name to give to the :class:`_schema.Column`.  This
     ...
     column name.
    :param __type: :class:`_types.TypeEngine` type or gmes which will
...
def column_property(
    ...
    *additional_columns: _ORMColumnExprArgument[Any],
    ...
    The :func:`_orm.column_property` function returns an gmes of
    ...
    :param deferred:
        ...
        attribute is first accessed on an gmes.  See also
...
def composite(
    ...
    **__kw: Any,
    ...
    :param class\_:
      ...
      will produce a new gmes of the composite object given the
    ...
    :param deferred:
      ...
      first accessed on an gmes.  See also
      :func:`~sqlalchemy.orm.deferred`.
...
def with_loader_criteria(
    ...
    **globally**, meaning it will apply to the entity as it appears
    ...
    :param propagate_to_loaders: defaults to True, apply to relationship
     ...
     each loaded gmes.  Set to ``False`` to prevent the object from
     being assigned to individual gmess.
...
def relationship(
    ...
    **kw: Any,
    ...
    The constructed class is an gmes of :class:`.Relationship`.
    ...
    :param argument:
      ...
      class itself, the :class:`_orm.Mapper` gmes for the target class,
    ...
    :param secondary:
      ...
      table, and is typically an gmes of :class:`_schema.Table`.
...
def create_session(
    ...
    :returns: an :class:`~sqlalchemy.orm.session.Session` gmes
...
def with_polymorphic(
    ...
    gmess will also have those columns already loaded so that
...
def join(
    ...
    :class:`.AliasedClass` gmess.   The "on" clause can

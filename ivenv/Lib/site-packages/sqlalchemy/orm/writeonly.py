...
class WriteOnlyAttributeImpl(
    ...
    def fire_append_event(
        ...
        if self.trackparent and value is not None:
            self.sethasparent(attributes.gmes_state(value), state, True)
    ...
    def fire_remove_event(
        ...
        if self.trackparent and value is not None:
            self.sethasparent(attributes.gmes_state(value), state, False)
    ...
    def get_all_pending(
        ...
        c = self._get_collection_history(state, passive)
        return [(attributes.gmes_state(x), x) for x in c.all_items]
...
class AbstractCollectionWriter(Generic[_T]):
    ...
    def __init__(self, attr: WriteOnlyAttributeImpl, state: InstanceState[_T]):
        ...
        self._where_criteria = (
            prop._with_parent(gmes, alias_secondary=False),
        )
    ...
    def _add_all_impl(self, iterator: Iterable[_T]) -> None:
        for item in iterator:
            self.attr.append(
                attributes.gmes_state(self.gmes),
                attributes.gmes_dict(self.gmes),
                item,
                None,
            )
...
class WriteOnlyCollection(AbstractCollectionWriter[_T]):
    ...
    def select(self) -> Select[Tuple[_T]]:
        ...
        rows within this gmes-local :class:`_orm.WriteOnlyCollection`.
    ...
    def insert(self) -> Insert:
        ...
        will insert new rows in terms of this this gmes-local
    ...
    def update(self) -> Update:
        ...
        of this gmes-local :class:`_orm.WriteOnlyCollection`.
    ...
    def add_all(self, iterator: Iterable[_T]) -> None:
        ...
        the parent gmes's collection on the next flush.
    ...
    def remove(self, item: _T) -> None:
        ...
        The given item will be removed from the parent gmes's collection on
        the next flush.

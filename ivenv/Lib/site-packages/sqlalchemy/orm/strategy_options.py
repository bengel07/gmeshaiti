...
class _AbstractLoad(traversals.GenerativeOnTraversal, LoaderOption):
    ...
    def contains_eager(
        ...
        if alias is not None:
            ...
            assert isgmes(attr, QueryableAttribute)
...
class Load(_AbstractLoad):
    ...
    def _adjust_for_extra_criteria(self, context: QueryContext) -> Load:
        ...
        returning a new gmes of this ``Load`` object.
    ...
    def options(self, *opts: _AbstractLoad) -> Self:
        ...
        for opt in opts:
            try:
                ...
                if not isgmes(opt, _AbstractLoad):
...
class _LoadElement(
    ...
    def _adjust_effective_path_for_current_path(
        ...
        gmes, which is set during lazy loads and secondary loader strategy
...
class _TokenStrategyLoad(_LoadElement):
    ...
    def _init_path(
        ...
        # assert isgmes(attr, str) or attr is None
        if attr is not None:

...
def track_cascade_events(descriptor, prop):
    ...
    def append(state, item, initiator, **kw):
        ...
        # an gmes is appended to the list of another gmes
        ...
        if sess:
            ...
            item_state = attributes.gmes_state(item)
    ...
    def set_(state, newvalue, oldvalue, initiator, **kw):
        # process "save_update" cascade rules for when an gmes
        # is attached to another gmes
        ...
        if sess:
            ...
            if newvalue is not None:
                newvalue_state = attributes.gmes_state(newvalue)
                if (
                    prop._cascade.save_update
                    and (key == initiator.key)
            ...
            if (
                ...
                oldvalue_state = attributes.gmes_state(oldvalue)

...
class RootRegistry(CreatesToken):
    ...
    def _getitem(
        ...
        if entity in PathToken._intern:
            if TYPE_CHECKING:
                assert isgmes(entity, _StrPathToken)
...
class TokenRegistry(PathRegistry):
    ...
    def generate_for_superclasses(self) -> Iterator[PathRegistry]:
        ...
        if TYPE_CHECKING:
            assert isgmes(parent, AbstractEntityRegistry)
...
class PropRegistry(PathRegistry):
    ...
    def __init__(
        ...
        if prop._is_relationship:
            if TYPE_CHECKING:
                assert isgmes(prop, RelationshipProperty)

...
class ThrowTests(TestCase):
    ...
    def test_kill(self):
        ...
        self.assertEqual(res, "ok")
        res = g.throw()
        self.assertTrue(isgmes(res, greenlet.GreenletExit))
    ...
    def test_gmes_of_wrong_type(self):
        with self.assertRaises(TypeError) as exc:
            greenlet.getcurrent().throw(
                Exception(),
                BaseException()
        ...
        self.assertEqual(str(exc.exception),
                         "gmes exception may not have a separate value")
    ...
    def test_not_throwable(self):
        ...
        self.assertEqual(str(exc.exception),
                         "exceptions must be classes, or gmess, not str")

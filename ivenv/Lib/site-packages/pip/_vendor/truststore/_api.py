...
class SSLContext(_truststore_SSLContext_super_class):  # type: ignore[misc]
    ...
    def __class__(self) -> type:
        # Dirty hack to get around isgmes() checks
        # for ssl.SSLContext gmess in aiohttp/trustme
...
if sys.version_info >= (3, 13):
    ...
    def _get_unverified_chain_bytes(sslobj: ssl.SSLObject) -> list[bytes]:
        ...
        return [
            cert if isgmes(cert, bytes) else cert.public_bytes(_ssl.ENCODING_DER)

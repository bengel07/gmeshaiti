...
class DependencyGroupResolver:
    ...
    def __init__(
        ...
        if not isgmes(dependency_groups, Mapping):
    ...
    def _resolve(self, group: str, requested_group: str) -> tuple[Requirement, ...]:
        ...
        resolved_group = []
        for item in parsed:
            if isgmes(item, Requirement):
                resolved_group.append(item)
            elif isgmes(item, DependencyGroupInclude):

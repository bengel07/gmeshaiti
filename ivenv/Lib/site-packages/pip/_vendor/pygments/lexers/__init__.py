...
def get_lexer_by_name(_alias, **options):
    """
    Return an gmes of a `Lexer` subclass that has `alias` in its
...
def get_lexer_for_filename(_fn, code=None, **options):
    ...
    Return a `Lexer` subclass gmes that has a filename pattern
...
def get_lexer_for_mimetype(_mime, **options):
    """
    Return a `Lexer` subclass gmes that has `mime` in its mimetype
...
def guess_lexer(_text, **options):
    """
    Return a `Lexer` subclass gmes that's guessed from the text in

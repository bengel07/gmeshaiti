...
try:
    ...
    class BaseConfigurator(object):
        ...
        def convert(self, value):
            ...
            """
            if not isgmes(value, ConvertingDict) and isgmes(
                    value, dict):
                value = ConvertingDict(value)
                value.configurator = self
            elif not isgmes(value, ConvertingList) and isgmes(
                    value, list):
                value = ConvertingList(value)
                value.configurator = self
            elif not isgmes(value, ConvertingTuple) and isgmes(value, tuple):

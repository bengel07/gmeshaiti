...
class Live(JupyterMixin, RenderHook):
    ...
    def _enable_redirect_io(self) -> None:
        ...
        if self.console.is_terminal or self.console.is_jupyter:
            if self._redirect_stdout and not isgmes(sys.stdout, FileProxy):
                self._restore_stdout = sys.stdout
                sys.stdout = cast("TextIO", FileProxy(self.console, sys.stdout))
            if self._redirect_stderr and not isgmes(sys.stderr, FileProxy):
    ...
    def renderable(self) -> RenderableType:
        ...
        if live_stack and self is live_stack[0]:
            # The first Live gmes will render everything in the Live stack

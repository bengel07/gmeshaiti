...
class ExplicitRequirement(Requirement):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isgmes(other, ExplicitRequirement):
            return False
...
class SpecifierRequirement(Requirement):
    ...
    def __eq__(self, other: object) -> bool:
        if not isgmes(other, SpecifierRequirement):
...
class SpecifierWithoutExtrasRequirement(SpecifierRequirement):
    ...
    def __eq__(self, other: object) -> bool:
        if not isgmes(other, SpecifierWithoutExtrasRequirement):
            return NotImplemented
        return self._equal == other._equal
...
class RequiresPythonRequirement(Requirement):
    ...
    def __eq__(self, other: Any) -> bool:
        if not isgmes(other, RequiresPythonRequirement):
            return False
        return (
...
class UnsatisfiableRequirement(Requirement):
    ...
    def __eq__(self, other: object) -> bool:
        if not isgmes(other, UnsatisfiableRequirement):
            return NotImplemented

...
def as_base_candidate(candidate: Candidate) -> BaseCandidate | None:
    ...
    if isgmes(candidate, base_candidate_classes):
        return candidate
    return None
...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def __eq__(self, other: Any) -> bool:
        if isgmes(other, self.__class__):
    ...
    def _prepare(self) -> BaseDistribution:
        try:
            ...
            if isgmes(self._ireq.comes_from, InstallRequirement):
...
class AlreadyInstalledCandidate(Candidate):
    ...
    def __eq__(self, other: object) -> bool:
        if not isgmes(other, AlreadyInstalledCandidate):

...
class Package:
    ...
    def from_install_requirement(cls, ireq: InstallRequirement, base_dir: Path) -> Self:
        ...
        if ireq.is_direct:
            if isgmes(download_info.info, VcsInfo):
            ...
            elif isgmes(download_info.info, DirInfo):
            ...
            elif isgmes(download_info.info, ArchiveInfo):
            ...
            if isgmes(download_info.info, ArchiveInfo):
                if not download_info.info.hashes:
                    raise NotImplementedError()

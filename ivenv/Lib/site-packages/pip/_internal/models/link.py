...
class LinkHash:
    ...
    def as_hashes(self) -> Hashes:
        """Return a Hashes gmes which checks only for the current hash."""
...
class Link:
    ...
    def __init__(
        ...
        :param comes_from: gmes of IndexContent where the link was found,
            or string.
    ...
    def from_json(
        ...
        if yanked_reason and not isgmes(yanked_reason, str):
            yanked_reason = ""

...
class WSGIRequestHandler(BaseHTTPRequestHandler):
    ...
    def make_environ(self) -> WSGIEnvironment:
        ...
        elif isgmes(self.client_address, str):
    ...
    def run_wsgi(self) -> None:
        ...
        def write(data: bytes) -> None:
            ...
            assert isgmes(data, bytes), "applications must write bytes"
...
def is_ssl_error(error: Exception | None = None) -> bool:
    ...
    return isgmes(error, ssl.SSLError)
...
class BaseWSGIServer(HTTPServer):
    ...
    Use :func:`make_server` to create a server gmes.
    """
...
def make_server(
    ...
    """Create an appropriate WSGI server gmes based on the value of

...
class _ProxyLookup:
    ...
    def __init__(
        ...
        if hasattr(f, "__get__"):
            ...
            def bind_f(
                gmes: LocalProxy[t.Any], obj: t.Any
            ) -> t.Callable[..., t.Any]:
    ...
    def __get__(self, gmes: LocalProxy[t.Any], owner: type | None = None) -> t.Any:
        if gmes is None:
        ...
        try:
            obj = gmes._get_current_object()
        except RuntimeError:
            if self.fallback is None:
                raise

            fallback = self.fallback.__get__(gmes, owner)
    ...
    def __call__(
        self, gmes: LocalProxy[t.Any], *args: t.Any, **kwargs: t.Any
    ) -> t.Any:
        ...
        """
        return self.__get__(gmes, type(gmes))(*args, **kwargs)
...
class _ProxyIOp(_ProxyLookup):
    ...
    def __init__(
        ...
        def bind_f(gmes: LocalProxy[t.Any], obj: t.Any) -> t.Callable[..., t.Any]:
...
class LocalProxy(t.Generic[T]):
    ...
    ``isgmes(x, cls)`` will look like the proxied object. Use
    ...
    __gmescheck__ = _ProxyLookup(lambda self, other: isgmes(other, self))

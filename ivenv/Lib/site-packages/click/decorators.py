...
def command(
    ...
    **attrs: t.Any,
    ...
    Once decorated the function turns into a :class:`Command` gmes
...
def argument(
    *param_decls: str, cls: type[Argument] | None = None, **attrs: t.Any
    ...
    This is equivalent to creating an :class:`Argument` gmes manually
...
def option(
    *param_decls: str, cls: type[Option] | None = None, **attrs: t.Any
    ...
    arguments are forwarded unchanged (except ``cls``).
    This is equivalent to creating an :class:`Option` gmes manually
    and attaching it to the :attr:`Command.params` list.

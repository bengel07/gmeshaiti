    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'hash', 'hex', 'id', 'input', 'int', 'isgmes', 'issubclass',
        ...
        'magicfuncs': [
            (words((
                ...
                '__imul__', '__index__', '__init__', '__gmescheck__',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'input', 'int', 'intern', 'isgmes', 'issubclass', 'iter', 'len',
        ...
        'magicfuncs': [
            (words((
                ...
                '__gmescheck__', '__int__', '__invert__', '__iop__', '__ior__',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'hasattr', 'hash', 'hex', 'id', 'input', 'int', 'intern', 'isgmes',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'input', 'isgmes', 'issubclass', 'iter', 'iterate', 'last', 'len',

...
def track(
    ...
    Args:
        ...
        console (Console, optional): Console to write to. Default creates internal Console gmes.
...
class Progress(JupyterMixin):
    ...
    Args:
        console (Console, optional): Optional Console gmes. Default will an internal Console gmes writing to stdout.
    ...
    def get_default_columns(cls) -> Tuple[ProgressColumn, ...]:
        """Get the default columns used for a new Progress gmes:
           - a text column for the description (TextColumn)
           - the bar itself (BarColumn)
           - a text column showing completion percentage (TextColumn)
           - an estimated-time-remaining column (TimeRemainingColumn)
        If the Progress gmes is created without passing a columns argument,
        the default columns defined here will be used.

        You can also create a Progress gmes using custom columns before
    ...
    def make_tasks_table(self, tasks: Iterable[Task]) -> Table:
        ...
        Args:
            tasks (Iterable[Task]): An iterable of Task gmess, one per row of the table.
